...
class KuGouMusicApi:
    ...
    def request(
        self, path, cookie={}, env: KugouProcessEnv = None, **query
    ) -> Response:
        if env is None:
            env = self.env
    ...
    def login_cellphone(
        self, mobile, code, userid=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        1.手机登录
        ...
        """
        return self.request(
            "/login/cellphone", cookie, env, mobile=mobile, code=code, userid=userid
        )

    def login(
        self, username, password, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        ...
        """
        return self.request("/login", cookie, env, username=username, password=password)

    def login_openplat(self, code, cookie="", env: KugouProcessEnv = None) -> Response:
        """
        3.开放接口登录(目前仅支持微信登录)
        ...
        """
        return self.request("/login/openplat", cookie, env, code=code)

    def login_qr_key(self, cookie="", env: KugouProcessEnv = None) -> Response:
        """
        4.二维码登录 - 生成 key
        说明: 调用此接口可生成一个 key
        接口地址： /login/qr/key
    ...
    def login_qr_create(
        self, key, qrimg=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        4.二维码登录 - 生成二维码
    ...
    def login_qr_check(self, key, cookie="", env: KugouProcessEnv = None) -> Response:
        """
        4.二维码登录 - 检查扫码状态
        ...
        """
        return self.request("/login/qr/check", cookie, env, key=key)

    def login_wx_create(self, cookie="", env: KugouProcessEnv = None) -> Response:
        """
        5.微信登录 - 生成二维码
        ...
        """
        return self.request("/login/wx/create", cookie, env)

    def login_wx_check(
        self, uuid, timestamp=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        5.微信登录 - 二维码检测扫码状态接口
        ...
        """
        return self.request(
            "/login/wx/check", cookie, env, uuid=uuid, timestamp=timestamp
        )

    def login_token(
        self, token=None, userid=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        刷新登录
    ...
    def user_playlist(
        self, page=None, pagesize=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        获取用户歌单
        ...
        调用例子： /user/playlist
        """
        return self.request("/user/playlist", cookie, env, page=page, pagesize=pagesize)
    ...
    def user_cloud(
        ...
        调用例子： /user/cloud
        """
        return self.request("/user/cloud", cookie, env, page=page, pagesize=pagesize)
    ...
    def user_video_collect(
        ...
        """
        return self.request(
            "/user/video/collect", cookie, env, page=page, pagesize=pagesize
        )

    def user_video_love(
        self, pagesize=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        获取用户喜欢的视频
        ...
        """
        return self.request("/user/video/love", cookie, env, pagesize=pagesize)

    def user_listen(
        self, type=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        获取用户听歌历史排行
        ...
        调用例子： /user/listen
        """
        return self.request("/user/listen", cookie, env, type=type)
    ...
    def playlist_tracks_add(
        self, listid, data, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        对歌单添加歌曲
        ...
        """
        return self.request(
            "/playlist/tracks/add", cookie, env, listid=listid, data=data
        )

    def playlist_tracks_del(
        self, listid, fileids, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        对歌单删除歌曲
        ...
        """
        return self.request(
            "/playlist/tracks/del", cookie, env, listid=listid, fileids=fileids
        )
    ...
    def top_album(
        ...
        """
        return self.request(
            "/top/album", cookie, env, type=type, page=page, pagesize=pagesize
        )

    def album(
        self, album_id, fields=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        专辑信息
    ...
    def album_songs(
        self, id, page=None, pagesize=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        专辑音乐列表
        ...
        """
        return self.request(
            "/album/songs", cookie, env, id=id, page=page, pagesize=pagesize
        )
    ...
    def search_complex(
        self, keywords, page=None, pagesize=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        综合搜索
    ...
    def lyric(
        ...
        """
        return self.request(
            "/lyric", cookie, env, id=id, accesskey=accesskey, fmt=fmt, decode=decode
        )
    ...
    def playlist_effect(
        ...
        """
        return self.request(
            "/playlist/effect", cookie, env, page=page, pagesize=pagesize
        )
    ...
    def playlist_track_all(
        ...
        """
        return self.request(
            "/playlist/track/all", cookie, env, id=id, page=page, pagesize=pagesize
        )

    def playlist_track_all_new(
        self, lisdid, page=None, pagesize=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        获取歌单所有歌曲(新版)
    ...
    def playlist_similar(self, ids, cookie="", env: KugouProcessEnv = None) -> Response:
        """
        相似歌单
        ...
        """
        return self.request("/playlist/similar", cookie, env, ids=ids)

    def theme_playlist_track(
        self, theme_id, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        获取主题歌单所有歌曲
        必选参数：
    ...
    def theme_music_detail(
        self, id, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        获取主题音乐详情
    ...
    def top_card(
        self, card_id, pagesize=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        歌曲推荐
        说明 : 调用此接口，可以获取歌曲推荐.
        ...
        """
        return self.request(
            "/top/card", cookie, env, card_id=card_id, pagesize=pagesize
        )
    ...
    def audio_accompany_matching(
        self, hash, fileName, mixid, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        获取音乐伴奏信息
        说明：调用此接口，可以获取最佳伴奏信息
    ...
    def audio_ktv_total(
        self, songId, singerName, songHash, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        获取音乐 K 歌数量
    ...
    def krm_audio(
        self, album_audio_id, fields=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        获取音乐专辑/歌手信息
        ...
        """
        return self.request(
            "/krm/audio", cookie, env, album_audio_id=album_audio_id, fields=fields
        )
    ...
    def ip(
        ...
        """
        return self.request(
            "/ip", cookie, env, id=id, type=type, page=page, pagesize=pagesize
        )
    ...
    def ip_playlist(
        ...
        """
        return self.request(
            "/ip/playlist", cookie, env, id=id, page=page, pagesize=pagesize
        )
    ...
    def youth_day_vip(
        self, receive_day, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
    ...
    def youth_month_vip_record(
        self, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
    ...
    def artist_detail(self, id, cookie="", env: KugouProcessEnv = None) -> Response:
        """
        获取歌手详情
    ...
    def artist_videos(
        ...
        """
        return self.request(
            "/artist/videos", cookie, env, id=id, page=page, pagesize=pagesize, tag=tag
        )
    ...
    def kmr_audio_mv(
        ...
        """
        return self.request(
            "/kmr/audio/mv", cookie, env, album_audio_id=album_audio_id, fields=fields
        )
    ...
    def scene_module_info(
        self, id, module_id, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        获取场景音乐模块 Tag
        ...
        """
        return self.request(
            "/scene/module/info", cookie, env, id=id, module_id=module_id
        )

    def scene_collection_list(
        self, tag_id, page=None, pagesize=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        获取场景音乐歌单列表
    ...
    def everyday_recommend(
        self, platform=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        每日推荐
        说明：调用此接口，可以获取每日推荐列表
        ...
        """
        return self.request("/everyday/recommend", cookie, env, platform=platform)

    def everyday_history(
        self,
        mode=None,
        history_name=None,
        date=None,
    ...
    def everyday_style_recommend(
        self, platform=None, tagids=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        风格推荐
        说明：调用此接口，可以获取风格推荐
        ...
        """
        return self.request(
            "/everyday/style/recommend", cookie, env, platform=platform, tagids=tagids
        )

    def rank_list(
        self, withsong=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        排行列表
        说明：调用此接口，可以获取排行榜列表
        ...
        调用例子： /rank/list
        """
        return self.request("/rank/list", cookie, env, withsong=withsong)
    ...
    def rank_vol(
        self, rankid, rank_cid=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        排行榜往期列表
        ...
        """
        return self.request("/rank/vol", cookie, env, rankid=rankid, rank_cid=rank_cid)
    ...
    def favorite_count(
        self, mixsongids, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        歌曲收藏数
        ...
        """
        return self.request("/favorite/count", cookie, env, mixsongids=mixsongids)

    def comment_count(
        self, hash, special_id, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        歌曲评论数
        ...
        """
        return self.request(
            "/comment/count", cookie, env, hash=hash, special_id=special_id
        )
    ...
    def sheet_detail(
        self, id, source, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        曲谱详情
        ...
        """
        return self.request("/sheet/detail", cookie, env, id=id, source=source)

    def sheet_hot(
        self, opern_type=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        推荐曲谱
        说明 : 调用此接口，可以获取推荐曲谱
        ...
        调用例子： /sheet/hot
        """
        return self.request("/sheet/hot", cookie, env, opern_type=opern_type)
    ...
    def playhistory_upload(
        self, mxid, ot=None, pc=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        提交听歌历史
        ...
        """
        return self.request("/playhistory/upload", cookie, env, mxid=mxid, ot=ot, pc=pc)
    ...
    def ai_recommend(
        self, album_audio_id, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        AI 推荐
        ...
        """
        return self.request("/ai/recommend", cookie, env, album_audio_id=album_audio_id)

    def youth_channel_all(
        self, page=None, pagesize=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        频道 - 获取用户所有频道
        ...
        """
        return self.request(
            "/youth/channel/all", cookie, env, page=page, pagesize=pagesize
        )

    def youth_channel_detail(
        self, global_collection_id, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        频道 - 详情
    ...
    def youth_channel_similar(
        self, channel_id, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        频道 - 相似频道
        ...
        """
        return self.request(
            "/youth/channel/similar", cookie, env, channel_id=channel_id
        )

    def youth_channel_sub(
        self, global_collection_id, t=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        频道 - 订阅
    ...
    def youth_channel_song_detail(
        self, global_collection_id, fileid, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        频道 - 音乐故事详情
    ...
    def youth_user_song(
        self, userid, page=None, pagesize=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        获取用户公开的音乐
        ...
        """
        return self.request(
            "/youth/user/song", cookie, env, userid=userid, page=page, pagesize=pagesize
        )

    def longaudio_daily_recommend(
        self, page=None, pagesize=None, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        听书 - 每日推荐
        ...
        """
        return self.request(
            "/longaudio/daily/recommend", cookie, env, page=page, pagesize=pagesize
        )

    def longaudio_rank_recommend(
        self, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        听书 - 排行榜推荐
    ...
    def longaudio_album_detail(
        self, album_id, cookie="", env: KugouProcessEnv = None
    ) -> Response:
        """
        听书 - 专辑详情
        必选参数：
    ...
    def song_ranking(
        ...
        """
        return self.request("/song/ranking", cookie, env, album_audio_id=album_audio_id)

    def song_ranking_filter(
        self,
        album_audio_id,
        page=None,
        pagesize=None,
